    ...
    return (
      <div style={styles.container}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>Loading system data...</p>
        </div>
        ...
        <div style={styles.grid}>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.mapPlaceholder}>
              ...
              <p>Real parcel boundaries and assessment data</p>
            </div>
          </div>
        </div>
              ...
              <tbody>
                {parcels.slice(0, 10).map((parcel) => (
                  <tr key={parcel.id}>
                    ...
                    <td style={styles.td}>{parcel.ownerName || 'N/A'}</td>
                    <td style={styles.td}>{parcel.address || 'N/A'}</td>
                    <td style={styles.td}>{parcel.assessedValue || 'N/A'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <ul style={{ color: '#374151', fontSize: '0.875rem' }}>
              ...
              <li>Property assessment documents</li>
              <li>Legal description parsing</li>
              <li>Automated parcel linking</li>
            </ul>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '0.875rem' }}>GIS Integration Ready</span>
            </div>
          </div>
        </div>
      </div>
