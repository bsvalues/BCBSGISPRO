...
import { AlertCircle, CheckCircle, FileText, MapPin, Settings } from 'lucide-react';
          ...
          <div>
            ...
            <Select value={workflowType} onValueChange={setWorkflowType}>
              ...
              <SelectContent>
                ...
                <SelectItem value="agricultural_assessment">Agricultural Assessment</SelectItem>
                ...
                <SelectItem value="zoning_compliance">Zoning Compliance</SelectItem>
              </SelectContent>
            </Select>
          </div>
      ...
      {workflowResult && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Source: {workflowResult.source}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {workflowResult.workflow && (
              <div>
                <h4 className="font-semibold mb-2">Analysis</h4>
                <p className="text-sm text-gray-600">{workflowResult.workflow.analysis}</p>
      ...
      {sm00Result && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Generated for {sm00Result.county}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Select value={blaOperation} onValueChange={setBlaOperation}>
              <SelectTrigger>
                <SelectValue placeholder="Select BLA operation" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="boundary_adjustment">Boundary Line Adjustment</SelectItem>
                <SelectItem value="merge">Parcel Merge</SelectItem>
      ...
      {blaResult && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Source: {blaResult.source}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
