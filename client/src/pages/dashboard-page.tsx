...
import { Workflow, WorkflowEvent, ChecklistItem, User } from "@shared/schema";
...
export default function DashboardPage() {
  ...
  const isLoading = isUserLoading || isWorkflowsLoading || isStatesLoading || isEventsLoading || isChecklistLoading;
