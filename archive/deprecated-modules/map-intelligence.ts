...
// Route to handle map intelligence queries
router.post('/map-intelligence', async (req, res) => {
  try {
...
`;
    ...
    console.error('Error in map-intelligence endpoint:', error);
    return res.status(500).json({ 
      error: 'Error processing map intelligence request',
      details: error.message 
    });
  }
});

// Route to handle map suggestions
router.post('/map-suggestions', async (req, res) => {
  try {
...
`;
    ...
    console.error('Error in map-suggestions endpoint:', error);
    return res.status(500).json({ 
      error: 'Error generating map suggestions',
      details: error.message 
    });
  }
});
...
router.post('/analyze-features', async (req, res) => {
  try {
    ...
    console.error('Error in analyze-features endpoint:', error);
    return res.status(500).json({ 
      error: 'Error analyzing map features',
      details: error.message 
    });
  }
});
